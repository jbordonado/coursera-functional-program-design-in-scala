  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var sol = (((-jsx$1) - $uD($g.Math.sqrt(a$1))) / (2 * $uD(a$2.apply__O())));
        var array = [sol, sol];
        ...
        var sol1 = (((-jsx$3) - $uD($g.Math.sqrt(a$3))) / (2 * $uD(a$2.apply__O())));
        var jsx$4 = $uD(b$2.apply__O());
        var a$4 = $uD(delta$1.apply__O());
        var sol2 = (((-jsx$4) + $uD($g.Math.sqrt(a$4))) / (2 * $uD(a$2.apply__O())));
        var array$1 = [sol1, sol2];
